  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        p: common_vendor.o(clickDownLoad)
      } : {}, {
        q: common_vendor.p({
          type: "closeempty",
          size: "18",
        ...
        y: common_vendor.f(currentInfo.value.tabs, (tab, k0, i0) => {
          return {
            a: common_vendor.t(tab),
            b: tab
          };
        }),
        z: common_vendor.sr(infoPopup, "2dad6c07-5", {
          "k": "infoPopup"
        }),
        A: common_vendor.p({
          type: "bottom"
        ...
        J: common_vendor.sr(scorePopup, "2dad6c07-8", {
          "k": "scorePopup"
        }),
        K: common_vendor.p({
          ["is-mask-click"]: false
